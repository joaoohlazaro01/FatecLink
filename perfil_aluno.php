...
$stmt = $pdo->prepare("
    SELECT u.nome, u.email, a.ra, a.curso, a.semestre, a.telefone 
    FROM usuarios u
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="dropdown user-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 rounded-3" aria-labelledby="dropdownUser">
                        <li><a class="dropdown-item py-2 active" href="perfil_aluno.php"><i class="bi bi-person-circle me-2"></i> Meu Perfil</a></li>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
                    <div class="bg-primary p-4 text-white text-center">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($perfil['nome']); ?>&size=100&background=ffffff&color=0d6efd" class="rounded-circle shadow-sm mb-3 border border-3 border-white">
                        <h3 class="fw-bold mb-0"><?php echo htmlspecialchars($perfil['nome']); ?></h3>
                        <p class="opacity-75 mb-0"><?php echo htmlspecialchars($perfil['curso']); ?> - RA: <?php echo htmlspecialchars($perfil['ra']); ?></p>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light border-0" value="<?php echo htmlspecialchars($perfil['nome']); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control bg-light border-0" value="<?php echo htmlspecialchars($perfil['email']); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light border-0" value="<?php echo htmlspecialchars($perfil['telefone']); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light border-0" value="<?php echo htmlspecialchars($perfil['curso']); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-light border-0" value="<?php echo htmlspecialchars($perfil['semestre']); ?>" readonly>
                                </div>
                            </div>
                        </div>
